...
from val_2D import test_single_volume, test_single_volume_ds, test_single_volume_fast
parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='../data/data_preprocessed/NPC/source', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='NPC_new/source', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    db_train = h5DataSet(base_dir=args.root_path, split=split, transform=transforms.Compose([
        RandomGenerator(args.patch_size, IntensityAug=True, SpatialAug=True, NonlinearAug=True)
    ]))
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            logging.info(
                'iteration %d :learning rate %f: loss : %f, loss_ce: %f, loss_dice: %f' %
